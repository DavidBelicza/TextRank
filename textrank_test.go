...
func TestRegularUsage(t *testing.T) {
	...
	Calculate(1, GetAlternateAlgorithm())
	GetPhrases(1)
	GetSingleWords(1)
	GetSentencesByRelationScore(1,6)
	GetSentencesByPhrases(1, []string{"gnome", "shell", "favourite"})
	GetSentencesFrom(1, 2, 2)
